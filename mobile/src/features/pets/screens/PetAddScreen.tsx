  ...
  const handleSavePet = async () => {
    ...
    try {
      ...
      if (res.success) {
        Alert.alert(
          'Thành công! 🎉',
          `Đã tạo hồ sơ cho bé ${name.trim()} vào tài khoản của bạn.`,
          [
            {
              text: 'OK',
              onPress: () => {
        ...
        Alert.alert('Lỗi', res.message || 'Không thể tạo hồ sơ thú cưng.');
      }
    } catch (error: any) {
      ...
      >
        ...
        >
          ...
          <Text style={styles.weightNote}>
            * Cân nặng giúp hệ thống tính size và báo giá dịch vụ spa/tắm chính xác nhất.
          </Text>
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              ...
              placeholder="VD: Bé dễ bị viêm tai, dị ứng với sữa tắm có cồn, đã tiêm đủ 3 mũi vaccine..."
              placeholderTextColor={theme.colors.text.muted}
              multiline
              numberOfLines={3}
              value={healthNote}
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              style={[styles.textInput, styles.textArea]}
              placeholder="VD: Rất thích được massage lưng, hơi sợ máy sấy kêu to, hòa đồng với người lạ..."
              placeholderTextColor={theme.colors.text.muted}
              multiline
              numberOfLines={3}
              value={behaviorNote}
        ...
        >
          {isSubmitting ? (
            ...
            <>
              ...
              <Text style={styles.submitBtnText}>Lưu Hồ Sơ Thú Cưng</Text>
            </>
          )}
        </TouchableOpacity>
      </View>
