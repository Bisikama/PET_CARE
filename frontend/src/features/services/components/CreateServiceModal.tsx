...
export const CreateServiceModal: React.FC<CreateServiceModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.message || 'Không thể tạo gói dịch vụ mới.');
    }
  };
  ...
  const modalContent = (
    ...
    >
      ...
      >
        {/* Header Section - Generous padding-top (pt-7 pb-6 px-7) to prevent overlap */}
        <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-[#031625] pt-7 pb-6 px-7 text-white flex items-center justify-between border-b border-slate-800 shrink-0 select-none relative overflow-hidden">
          ...
          <div className="absolute right-0 top-0 w-56 h-56 bg-teal-500/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="flex items-center gap-4 relative z-10 min-w-0 pr-4">
            ...
            <div className="space-y-1 min-w-0">
              ...
              <p className="text-xs text-slate-400 font-medium leading-normal">
                Cấu hình thông tin dịch vụ thú cưng hệ thống (Admin)
              </p>
            </div>
          </div>
        ...
        {/* Modal Body - Independent vertical scroll (overflow-y-auto) & flexible height */}
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
          <div className="flex-1 overflow-y-auto p-6 md:p-7 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="VD: Tắm Thảo Dược & Cắt Tỉa Tạo Kiểu Premium"
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                placeholder="Nhập mô tả chi tiết quy trình thực hiện, dịch vụ bao gồm..."
          ...
          <div className="p-5 md:p-6 border-t border-slate-100 bg-slate-50/50 flex items-center justify-end gap-3 shrink-0">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-2 px-6 py-2.5 rounded-2xl bg-teal-600 hover:bg-teal-500 text-white text-xs font-extrabold shadow-lg shadow-teal-500/20 transition-all duration-150 active:scale-95 cursor-pointer disabled:opacity-50"
            >
              {submitting ? (
                <>
