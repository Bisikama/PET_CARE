...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service }) => {
  ...
  return (
    <>
      <div className="group relative bg-white rounded-[24px] border border-slate-100/80 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col h-full">
        ...
        <div className="px-6 pb-6 pt-0 mt-auto relative z-10">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-semibold border border-slate-100 bg-slate-50 text-slate-600 hover:bg-teal-600 hover:text-white hover:border-transparent transition-all duration-200 active:scale-[0.98] cursor-pointer"
          >
            Xem chi tiết
          </button>
        </div>
      ...
      {/* Service Detail Modal (GET /api/services/:id) */}
      <ServiceDetailModal
